...
const isEnabled = (wallets: any, name: string) => {
  return (
    wallets.filter(
      (wallet: any) => wallet.name === name && wallet.enabled === true
    ).length > 0
  );
};
